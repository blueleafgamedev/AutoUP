    ...
    if 'available' not in checkup:
        ...
        if answer == 'y' or answer == 'yes':
            ...
            if 'not' in restart:
                ...
                print(restart)
                answer = (emoji.emojize('It looks like some updates require a restart. Would you like me to do this? :thinking_face: [Y/n] ')).lower().strip()
                if answer == 'y' or answer == 'yes':
        ...
        print(checkup)
        answer = input(emoji.emojize('The above updates are available. Would you like me to run them? :thinking_face: [Y/n] ')).lower().strip()
